...
class TestPrioritizedReplayBuffer:
    ...
    def _transition(self, reward=0.0, done=False):
        return dict(
...
class TestNStepAccumulator:
    ...
    def _t(self, reward=0.0, done=False):
        return dict(
...
class TestDQNAgent:
    ...
    def _fill_replay(self, agent, n=100):
        obs_dim = 27
        for i in range(n):
    ...
    def test_action_selection_respects_mask(self):
        ...
        obs   = np.random.randn(32, 27).astype(np.float32)
